...
#include "common.h"
	...
	struct variable variables_LANHostConfig[] = {
			...
			{"vpns_ov_custom", "", NULL, EVM_RESTART_VPNSVR},
			{"vpns_ov_auth", "", NULL, EVM_RESTART_VPNSVR},
			...
			{"vpnc_ov_passfile", "", NULL, EVM_RESTART_VPNCLI},
			...
			{"ovpnsvr.server.ovpn", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			...
			{"ovpnsvr.psw-file", "File", NULL, EVM_RESTART_VPNSVR|EVM_BLOCK_UNSAFE},
			...
			{"ovpncli.password-1.txt", "File", NULL, EVM_RESTART_VPNCLI|EVM_BLOCK_UNSAFE},
			{"ovpncli.password-2.txt", "File", NULL, EVM_RESTART_VPNCLI|EVM_BLOCK_UNSAFE},
			{"ovpncli.password-3.txt", "File", NULL, EVM_RESTART_VPNCLI|EVM_BLOCK_UNSAFE},
			{"ovpncli.password-4.txt", "File", NULL, EVM_RESTART_VPNCLI|EVM_BLOCK_UNSAFE},
			{"ovpncli.password-5.txt", "File", NULL, EVM_RESTART_VPNCLI|EVM_BLOCK_UNSAFE},
#endif
